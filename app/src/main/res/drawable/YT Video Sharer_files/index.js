      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <div><a href="#" onclick=getProfile(${postInfo.username})>${escapeHTML(postInfo.username)}</a>, ${(new Date(escapeHTML(postInfo.created_date))).toLocaleString("en-us", { dateStyle: "medium", timeStyle: "short" })}</div>
            <br>
